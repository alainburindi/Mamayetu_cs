	...
	@if(count($events) > 0)
		@foreach($events->all() as $event)
			<div class="col-lg-8 col-lg-push-2">
				...
				<div class="row">
					<img src="storage/images/events/<?php echo $event->event_pic;?>" class="col-lg-11 w-100" height="300px" class="img-responsive">
					@guest
					{{-- @else --}}
					...
					<div class="row col-lg-1" style="margin-top: 30px">
						...
						{!! Form::open(['action' => ['EventsController@destroy', $event->id], 'method' => 'POST', 'class' => ''] ) !!}
